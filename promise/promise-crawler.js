...
var Promise = require("bluebird"); //ES6 buit-in object
var cheerio = require("cheerio");
var baseUrl = "http://www.imooc.com/learn/";   //基本的地址
var videoIds = [348,637,259,75,197];

var courseArray = [];   //课程数组，放的是每个promise
videoIds.forEach(function(courseId){
	courseArray.push(getPageAsync(baseUrl+courseId));  //往数组里追加每个课程的promise
});
